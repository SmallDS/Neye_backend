...
export class SystemSettingsController {
  ...
  @Get('wechat-pickup-notification')
  @Roles(UserRole.admin)
  getWechatPickupNotification() {
    return this.systemSettingsService.getWechatPickupNotification();
  }

  @Patch('wechat-pickup-notification')
  @Roles(UserRole.admin)
  @LogEvent({ module: 'system_settings', action: 'WECHAT_PICKUP_NOTIFICATION_UPDATED', resourceType: 'system_setting', level: EventLogLevel.WARN })
  updateWechatPickupNotification(@Body() dto: UpdateWechatPickupNotificationDto) {
    return this.systemSettingsService.updateWechatPickupNotification(dto);
  }
  @Get('optometry-style')
